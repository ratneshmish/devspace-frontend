...
const Connections = () => {
  ...
  if (connectiondata.length === 0) return<div className="min-h-[70vh] flex justify-center items-center"><h1 className=" text-xl font-bold">No connection found!</h1></div> 
  ...
  return (
    <div className="bg-black text-gray-200 py-10 min-h-screen">
      ...
      <ul className="max-w-5xl mx-auto grid gap-8 sm:grid-cols-2 md:grid-cols-3">
        {connectiondata.map(({ firstName, lastName, photoUrl, about }, idx) => (
          <Tilt
            key={idx}
            tiltMaxAngleX={10}
            tiltMaxAngleY={10}
